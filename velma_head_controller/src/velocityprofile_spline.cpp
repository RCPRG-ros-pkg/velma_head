...
void VelocityProfile_Spline::Write() const
{
  std::cout << "coefficients : [ " << coeff_[0] << " " << coeff_[1] << " " << coeff_[2] << " " << coeff_[3] << " " << coeff_[4] << " " << coeff_[5] << " ]";
  return;
}

VelocityProfile_Spline* VelocityProfile_Spline::Clone() const
{
